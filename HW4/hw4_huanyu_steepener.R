...
plot(x = date_axis,convexity_return,type = "l",col = "red",xaxt="n", xlab="date", ylab = "cumulative return ($)")
axis(side = 1, at = date_axis, labels = x_date)
legend("topright", legend = c("Convexity Risk"), col = c("red"),lty=1)
...
myplot = function(a){
  plot(x = date_axis,cumsum(a[,7]),type = "l",col = "red",xaxt="n", xlab="date", ylab = "cumulative return ($)")
  axis(side = 1, at = date_axis, labels = x_date)
  ...
  # legend("topright", legend = c("total return","spread return","convexity return","time return","residual return"), col = c("red","blue","orange","green","black"),lty=1,cex=0.7)
  grid(NULL,NULL,col="lightgrey",lty="dotted")
}


myplot_b = function(a,b){
  plot(x = date_axis,cumsum(a[,7]),type = "l",col = "blue", xlab = "date", ylab = "cumulative return ($)", xaxt = "n")
  axis(side = 1, at = date_axis, labels = x_date)
